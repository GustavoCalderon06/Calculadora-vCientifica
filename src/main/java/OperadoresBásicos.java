public class OperadoresBásicos {
    ...
    public static double Valor1() {
        ...
        System.out.print("x1 = ");
        double x1 = Ingresar.ingresarDouble();
        return x1;
    }
    ...
    public static double Valor2() {
        ...
        System.out.print("x2 = ");
        double x2 = Ingresar.ingresarDouble();
        return x2;
    }
    ...
    public static void PorcentajeX1(double variable1) {
        ...
        double porcentaje1b = Ingresar.ingresarDouble();
    ...
    public static void PorcentajeX2(double variable2) {
        ...
        double porcentaje2b = Ingresar.ingresarDouble();
